            ...
            >
                {gridData.map((cell, index) => (
                    <input
                        ...
                        className={`flex items-center justify-center border border-gray-300 bg-white h-10 text-gray-700 font-medium text-center uppercase focus:outline-none focus:ring-2 ${selectedIndices.includes(index) ? "bg-blue-200" : ""
                            }`}
                    />
                ))}
            </div>
