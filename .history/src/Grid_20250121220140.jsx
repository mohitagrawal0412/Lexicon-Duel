    ...
    return (
        ...
        >
            ...
            >
                {gridData.map((cell, index) => (
                    <input
                        ...
                        style={{
                            backgroundColor: selectedIndices.includes(index) ? 'blue' : 'white',
                        }}
            ...
            <button
                ...
                className="mt-4 px-6 py-3 bg-blue-500 text-white font-medium rounded-lg shadow-md hover:bg-blue-300 focus:outline-none focus:ring-2 focus:ring-blue-100"
            >
                Switch Turn
            </button>
        </div>
