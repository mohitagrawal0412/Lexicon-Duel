...
const Grid = ({ size, onBack }) => {
    ...
    const handleMouseDown = (index) => {
        console.log('Selected cell onMouseDown:', index); // Debug log
    ...
    const handleMouseEnter = (index) => {
        if (isSelecting) {
            ...
            if (selectionDirection === 'horizontal' && rowStart === rowCurrent) {
                ...
                console.log('Updated horizontal selection:', newSelected); // Debug log
                ...
                console.log('Updated vertical selection:', newSelected); // Debug log
                setSelectedIndices(newSelected);
            }
        }
    };
