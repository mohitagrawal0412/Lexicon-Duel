...
import { ArrowLeft, Users, Globe, Lock, Calculator } from 'lucide-react';

export default function TargetBattleSetupPage() {
    ...
    <div className="min-h-screen game-bg p-6 flex flex-col items-center">
      <div className="w-full max-w-2xl mb-8 flex items-center justify-between">
        ...
        <h1 className="text-3xl md:text-4xl font-black text-transparent bg-clip-text bg-gradient-to-r from-blue-400 to-indigo-500 tracking-tight text-center flex items-center gap-2">
          <Calculator className="text-blue-400" /> TARGET BATTLE
        </h1>
      ...
      <div className="w-full max-w-md space-y-6">
        ...
        {/* Local Mode */}
        <button
          onClick={() => navigate('/target-battle/play')}
        ...
        >
          ...
          <p className="text-sm text-gray-500 leading-relaxed">
            Combine your 6 starting numbers using math operators to reach the Target Number. You have 60 seconds. The player closest to the target wins the round!
          </p>
        </button>
        ...
        <div className="w-full bg-surface-900/30 backdrop-blur-xl border border-white/5 rounded-3xl p-6 relative overflow-hidden opacity-75">
          ...
          <div className="flex items-center gap-4 mb-4">
            ...
            <div>
              ...
              <p className="text-sm text-gray-400">Battle mathematicians globally</p>
            </div>
          </div>
        </div>
